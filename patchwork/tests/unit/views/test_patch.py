...
class PatchListLabelFilteringTest(TestCase):
    def setUp(self):
        ...
        self.patches = [
            ...
            create_patch(submitter=person, project=self.project, labels=[self.label1]),
            create_patch(submitter=person, project=self.project, labels=[self.label1, self.label2]),
            create_patch(submitter=person, project=self.project, labels=[self.label1, self.global_label]),
        ]
